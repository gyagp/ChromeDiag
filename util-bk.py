...
if __name__ == '__main__':
    ...
    left_frame = Frame(root)
    left_frame.pack(side=LEFT)
    Button(left_frame, text="Diag").pack()
    diag_listbox = ScrolledListbox(left_frame, 'xy', width=80, height=height)
    diag_listbox.pack()

    right_frame = Frame(root)
    right_frame.pack(side=LEFT)
    Button(right_frame, text="Bisect").pack()
    bisect_listbox = ScrolledListbox(right_frame, 'xy', width=100, height=height)
    bisect_listbox.pack()
    root.mainloop()
